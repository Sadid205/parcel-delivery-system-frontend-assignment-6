...
export default function About({
  ...
  mainImage = {
    src: "/images/young-man-delivering-package-customer-home-delivery.jpg",
    alt: "placeholder",
  },
  secondaryImage = {
    src: "/logo.svg",
  ...
  breakout = {
    ...
    description: "Providing businesses with effective delivery system",
  ...
  return (
    <section className="py-32 m-auto container">
